...
static const WebPageDesc_t s_WebPages[] =
{
    // Performance page:
    {   NumberAPAuthModes,
        L"/html/aPerformanceSetting.htm?1"
    },

    // WEP settings page:
    {   APAuthShared,
        L"/html/bWirelessSetting.htm?1,0,0"
    },

    // WPA (Radius) settings page:
    {   APAuthWPA,
        L"/html/bWirelessSetting.html?1,0,3"
    },

    // PSK settings page:
    {   APAuthWPA_PSK,
        L"/html/bWirelessSetting.html?1,0,4"
    }
};
...
static const WCHAR s_DeviceInfoPage[] = L"/html/sDeviceInfo.htm";

// Device-reset page:
static const WCHAR s_ResetPage[] = L"/html/RestartSystem.htm";
