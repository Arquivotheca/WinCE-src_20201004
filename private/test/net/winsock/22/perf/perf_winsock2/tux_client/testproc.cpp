...
// --------------------------------------------------------------------
{
    INT nResult = TPR_INFORMATIVE;
    INT rateResult = TPR_INFORMATIVE;
    ...
    do
    {
        ...
        for (INT i=0; i<g_nTestBufferCount; i+=1)
        {
            ...
            if (nResult == TPR_INFORMATIVE && err == Test_Success)
            {
...
{
    INT nResult = TPR_INFORMATIVE;
    INT nRateResult = TPR_INFORMATIVE;
    INT iTestCpuUtilCount;
...
Cleanup:
    ...
    if(nRateResult == TPR_INFORMATIVE)
       return nResult;
    else
      return nRateResult;
}
...
Cleanup:
    ...
    Log(DEBUG_MSG, TEXT("-RunTest(); returning %s"),
        TestResult == TPR_INFORMATIVE ? TEXT("TPR_INFORMATIVE") : TEXT("TPR_FAIL"));
