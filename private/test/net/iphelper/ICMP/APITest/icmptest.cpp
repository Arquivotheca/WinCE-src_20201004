...
TESTPROCAPI IcmpAPITest (UINT uMsg, 
    ...
    SOCKADDR_IN             saDestinationV4 = {0};
    SOCKADDR_IN6            saDestinationV6 = {0};
    SOCKADDR_IN6            saSourceV6 = {0};
    LPSOCKADDR              lpsaDest = {0};
    
    ULONG                   ulTimeout       = DEFAULT_TIMEOUT;
    
    PICMP_ECHO_REPLY        pReplyV4 = {0};
    PICMPV6_ECHO_REPLY      pReplyV6 = {0};
