...
class CEllipseTestSuite : public CTestSuite
{
    public:
        CEllipseTestSuite(CSection * Section) : CTestSuite(Section), 
                                            ...
                                            { info(DETAIL, TEXT("In CEllipseTestSuite overloaded constructor.")); }
         ~CEllipseTestSuite() { info(DETAIL, TEXT("In CEllipseTestSuite destructor.")); }
...
private:
        CEllipseTestSuite() { info(DETAIL, TEXT("In CEllipseTestSuite base constructor.")); }
