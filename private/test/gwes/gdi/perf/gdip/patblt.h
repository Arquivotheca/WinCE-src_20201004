...
class CPatBltTestSuite : public CTestSuite
{
    public:
        CPatBltTestSuite(CSection * Section) : CTestSuite(Section),
                                            ...
                                            { info(DETAIL, TEXT("In CPatBltTestSuite overloaded constructor.")); }
         ~CPatBltTestSuite() { info(DETAIL, TEXT("In CPatBltTestSuite destructor.")); }
...
private:
        CPatBltTestSuite() { info(DETAIL, TEXT("In CPatBltTestSuite base constructor.")); }
