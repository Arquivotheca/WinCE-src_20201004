...
// List Virtual Credential Providers
    ...
    while (lRet == ERROR_SUCCESS)
    {
        cbKeyName=MAX_PATH;    
        cbCredProvName=MAX_PATH;    
        _tcscpy_s(szCredNameFull, MAX_PATH, HKEY_CRED_PROV_VIRTUAL);
        _tcscat_s(szCredNameFull, MAX_PATH, TEXT("\\"));
...
BOOL ListPrimitiveProviders(){
    ...
    while (lRet == ERROR_SUCCESS)
    {
     cbKeyName=MAX_PATH;    
    cbCredProvName=MAX_PATH;    
    _tcscpy_s(szCredNameFull, MAX_PATH, HKEY_CRED_PROV_PRIMITIVE);
    _tcscat_s(szCredNameFull, MAX_PATH, TEXT("\\"));
...
// List Virtual Credential Providers
    ...
    _tcscat_s(szCredNameFull, MAX_PATH, TEXT("\\"));
       ...
       lRet = RegEnumKeyEx(hKey, dwIdx, szKeyName, &cbKeyName, 0, 0, 0, NULL);
        ...
        _tcscat_s(szCredNameFull, MAX_PATH, szKeyName);
