...
#define PG_PERMISSION_MASK      0x00000FDF  // exclude PG_ACCESSED_MASK
...
{
    DWORD dwMask = PG_PERMISSION_MASK;
    dwMask &= ~(PG_ACCESSED_MASK|PG_DIRTY_MASK);//ignore DIRTY and ACCESSED bits
    return (dwEntry1 & dwMask) == (dwEntry2 & dwMask);
}
