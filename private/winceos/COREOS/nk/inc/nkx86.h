...
// begin_nthal
//
// Exception Registration structure defined in winnt.h
//
...
#define CONTEXT_TO_FRAME_POINTER(Context) ((Context)->Ebp)
...
extern DWORD ProcessorFeaturesECX;
