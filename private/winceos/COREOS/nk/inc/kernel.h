...
#define PageFreeCount_Pool      (*(PLONG)&KInfoTable[KINX_PAGEFREE])
...
DWORD WINAPI CleanPagesThread (LPVOID param);
...
// SList support.
extern FARPROC g_pfnExpInterlockedPopEntrySListFault;
extern FARPROC g_pfnExpInterlockedPopEntrySListEnd;
extern FARPROC g_pfnExpInterlockedPopEntrySListResume;

extern FARPROC g_pfnKrnExpInterlockedPopEntrySListFault;
extern FARPROC g_pfnKrnExpInterlockedPopEntrySListEnd;
extern FARPROC g_pfnKrnExpInterlockedPopEntrySListResume;
...
// hardware failure exception code
#define STATUS_HARDWARE_FAILURE         (0xDFFF0123)
