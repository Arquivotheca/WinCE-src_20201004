...
*       01-28-05  SJ    Making DEBUG_LOCK preallocated.
*
*******************************************************************************/
...
#ifdef _WIN32_WCE // CE doesn't support SPIN count
                InitializeCriticalSection( _locktable[locknum].lock );
#else                
        ...
        )
{
        ...
        if ( _locktable[locknum].lock == NULL ) {
             ...
             */
            //TODO: VS11 porting: Need to determine how to initialize _OSFHND_LOCK for
...
{
#ifndef _WIN32_WCE // CE doesn't support FatalAppExit api, and CE doesn't support packaged application
