...
*       01-13-88  SKS   Changed bogus "_fileno_nolock" to "fileno"
...
*       03-13-04  MSL   Test lseek return for prefast
*       11-11-04  MR    Set errno to ERANGE for overflows - VSW#305392
*       08-22-05  AEI   Fixed VSW#546665: _lseek is replaced with _lseeki64, because
*                       _lseek returns -1 in case the file is bigger than 32 bit int max
*
*******************************************************************************/
