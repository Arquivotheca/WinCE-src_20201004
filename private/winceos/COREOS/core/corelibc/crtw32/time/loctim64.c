...
*       12-13-05  ATC   Fixed calculation of tm_yday when it is before the epoch
*       		Added case when timezone offset increments the date for
*       		the special case calculation
*
*******************************************************************************/
