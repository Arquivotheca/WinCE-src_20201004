...
*                       variable, remove stdin, stdout, stderr entries of _osfile
...
*       03-24-04  MSL   Fixed to not set errno as required by standard
*                       VSW #263685
...
#ifndef _WIN32_WCE // CE doesn't support the DETACHED_PROCESS
...
#ifdef WPRFLAG
#ifndef _WIN32_WCE // CE doesn't support the CREATE_UNICODE_ENVIRONMENT 
