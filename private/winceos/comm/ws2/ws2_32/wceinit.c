    ...
    )
{
    ...
    case DLL_PROCESS_DETACH:
        ...
        if (v_hDll) {
            ...
            // Calling TlsFree to free the slot that was allocated by CeTlsAlloc
            // No need to TlsSetValue(s_SockTlsSlot, 0) needed in DeleteTlsData,
            //                              because DeleteTlsData is per thread.
            // TlsFree - free the slot
            DEBUGMSG (ZONE_MISC, (TEXT("WS2: dll detach()\r\n")));
