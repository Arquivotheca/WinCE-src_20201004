...
typedef enum _MDMSTATE
{
    ...
    MDMST_HANGING_UP_CMD,     // Wait for a response to ATH<cr>
                              // If you get one, you are not responding, raise DTR, set state to
...
void GetHangupCommands(PTLINEDEV pLineDev, LPSTR pEscapeCmd, DWORD cchEscapeCmd, LPSTR pHangupCmd, DWORD cchHangupCmd, LPSTR pResetCmd, DWORD cchResetCmd);
