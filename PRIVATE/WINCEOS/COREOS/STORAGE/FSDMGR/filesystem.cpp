...
#pragma prefast(disable: 5453, "FSStub_LResult expects fewer parameters than PFNFORMATVOLUME passes")
        // This FSD does not provide a FSD_FormatVoluem export.
        m_pfnFormatVolume = (PFNFORMATVOLUME)FSStub_LResult;
#pragma prefast(pop)
    }
