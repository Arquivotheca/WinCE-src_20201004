    ...
    UPNPCB_ID requestId)
{
    ...
    if(requestXml) numberOfTagDescriptions++;
    if(serviceId) numberOfTagDescriptions++;
    if(udn) numberOfTagDescriptions++;
    ...
    m_UpnpInvokeRequestBufferSize += sizeof(UpnpRequest);
    m_UpnpInvokeRequestBufferSize += requestXmlLength;
    m_UpnpInvokeRequestBufferSize += serviceIdLength;
    m_UpnpInvokeRequestBufferSize += udnLength;
