...
{
    BOOLEAN l_bWaitForPresent = FALSE, l_bWaitForAbsent = FALSE, l_bResult;
        ...
        switch (l_uState)
        {
            ...
            case SCARD_POWERED:
                ...
                TestCheck(
                    ...
                    MapWinErrorToNtStatus(l_lResult),
                    STATUS_CANCELLED,
                    MapWinErrorToNtStatus(STATUS_CANCELLED)
                    );
    ...
    )
{
        ...
        //LogOpen(TestLoadStringResource(IDS_PROGRAM_NAME).GetBuffer(0));
        ...
        switch(in_dwTestID) {
            ...
            case TEST_ID_SMARTCARDPROVIDERTEST:
            {
                ...
                if (l_pchTestNo = l_CArgv.ParameterExist(L"t"))
                {
...
#ifdef UNDER_CE
void ParseCommandLine(__inout TCHAR* pCmdLine, PTCHAR argv[], UCHAR *argc)
{
    PTCHAR pch;
