...
StartRecording:
	...
	if(expected<0)	{
		...
		QueryCondition((expected>=1000),"ERROR:  notification not received within one second after expected capturetime",TPR_ABORT,"Driver is not signalling notification at all");
	}
	if(g_interactive) {
